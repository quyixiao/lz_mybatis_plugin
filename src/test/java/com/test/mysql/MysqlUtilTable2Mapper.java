...
public class MysqlUtilTable2Mapper {
    ...
    public static void printDao(TablesBean tableBean) {
        ...
        String fileName = PMysqlMain.save_path + "/" + realName + "Dao.java";

        if (StringUtils.isNotBlank(PMysqlMain.mapper_path)) {
            fileName = PMysqlMain.mapper_path + "/" + realName + "Dao.java";
        }


        try {

            String content = "package " + PMysqlMain.dao_package + ";\n";
            ...
            content += "import " + PMysqlMain.bean_package + "." + realName + ";\n" +
